...
describe('orderBy', () => {
  ...
  it('deberia retornar un arreglo ordenado (AZ)', () => {
    ...
    expect(result).toEqual([dataGhibli[0],dataGhibli[3],dataGhibli[2], dataGhibli[1], dataGhibli[4]]);
  });

  it('deberia retornar un arreglo ordenado (ZA)', () => {
    const result = orderBy(data, 'ZA')
    expect(result).toEqual([dataGhibli[4],dataGhibli[1],dataGhibli[2], dataGhibli[3], dataGhibli[0]]);
  });

  it('deberia retornar un arreglo ordenado (score del minimo al maximo)', () => {
    const result = orderBy(data, 'scoreMinToMax')
    expect(result).toEqual([dataGhibli[1],dataGhibli[0],dataGhibli[2], dataGhibli[3], dataGhibli[4]]);
  });

  it('deberia retornar un arreglo ordenado (score del maximo al minimo)', () => {
    const result = orderBy(data, 'scoreMaxToMin')
    expect(result).toEqual([dataGhibli[4],dataGhibli[3],dataGhibli[2], dataGhibli[0], dataGhibli[1]]);
  });

  it('deberia retornar un arreglo ordenado (de la más antigua a la más reciente)', () => {
    const result = orderBy(data, 'dateMinToMax')
    expect(result).toEqual([dataGhibli[0],dataGhibli[3],dataGhibli[1], dataGhibli[2], dataGhibli[4]]);
  });

  it('deberia retornar un arreglo ordenado (de la más reciente la más antigua)', () => {
    const result = orderBy(data, 'dateMaxToMin')
    expect(result).toEqual([dataGhibli[4],dataGhibli[2],dataGhibli[3], dataGhibli[1], dataGhibli[0]]);
  });
...
describe('characterFilter', () => {
  ...
  it('returns characters of Castle in the Sky`', () => {
    const result = characterFilter("Castle in the Sky", data)
    expect(result).toEqual(dataGhibli[0].people);
  });

  it('returns characters of Kikis Delivery Service ', () => {
    const result = characterFilter("Kiki's Delivery Service", data)
    expect(result).toEqual(dataGhibli[2].people);
  });
  
  it('returns characters of Only Yesterday', () => {
    const result = characterFilter("Only Yesterday", data)
    expect(result).toEqual(dataGhibli[4].people);
  });
...
describe('locationFilter', () => {
  it('is a function', () => {
    expect(typeof locationFilter).toBe('function');
  });

  it('returns Location of the Castle in the sky', () => {
    const result = locationFilter("Castle in the Sky",data)
    expect(result).toEqual(dataGhibli[0].locations);
  });

  it('returns Undefined', () => {
    const result = locationFilter("titulo que no esta en ghibli",data)
...
describe('vehicleFilter', () => {
  ...
  it('returns Vehicle of Castle in the sky', () => {
    const result= vehicleFilter('Castle in the Sky', data)
    expect(result).toEqual(dataGhibli[0].vehicles);
  });

  it('returns Undefined', () => {
    const result = vehicleFilter("titulo que no esta en ghibli",data)
    expect(result).toEqual(undefined);
  });
});
